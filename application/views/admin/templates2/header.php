...
<html lang="en">
  <head>
    ...
    <script>
      WebFont.load({
        ...
        custom: {
          ...
          urls: ["<?php echo base_url(); ?>assets/backend/assets/css/fonts.min.css"],
        },
        active: function () {
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/backend/assets/css/plugins.min.css" />
