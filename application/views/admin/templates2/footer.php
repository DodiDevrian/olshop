    ...
    <!--   Core JS Files   -->
    <script src="<?= base_url() ?>/assets/backend/assets/js/core/jquery-3.7.1.min.js"></script>
    ...
    <!-- Kaiadmin JS -->
    <script src="<?= base_url() ?>/assets/backend/assets/js/kaiadmin.min.js"></script>
    <!-- Kaiadmin DEMO methods, don't include it in your project! -->
    <script src="<?= base_url() ?>/assets/backend/assets/js/setting-demo2.js"></script>
    <script>
